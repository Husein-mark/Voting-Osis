          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <a class="btn btn-primary mt-3 w-15 ms-4" href="../Siswa/tambah_siswa.php">Tambah Data</a>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="align-middle g-2 text-center">
                        <a href="../Siswa/edit_siswa.php?id=<?= $data['id_siswa'] ?>" class= "font-weight-bold text-xs badge badge-sm bg-gradient-primary" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                        <a href="#" class=" font-weight-bold text-xs badge badge-sm bg-gradient-danger"
                        onclick="hapusSiswa(<?= $data['id_siswa']; ?>)" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                      </td>
                    </tr>
